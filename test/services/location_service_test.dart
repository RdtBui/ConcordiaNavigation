...
void main() {
  ...
  group('LocationService', () {
    ...
    setUp(() {
      ...
      when(location.requestPermission()).thenAnswer((_) => Future.value(null)); // Ignore this function call
    ...
    test('creates same instance of LocationService + creates UserLocation', () async {
      // Try to create again
